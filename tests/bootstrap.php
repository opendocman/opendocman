...
require_once APPLICATION_PATH . '/models/TextExtractor.class.php';
require_once APPLICATION_PATH . '/models/TextExtractorFactory.class.php';
require_once APPLICATION_PATH . '/models/Document.class.php';
