...
//Example:
$GLOBALS['database'] = 'odm_temp'; // Enter the name of the database here
$GLOBALS['user'] = 'odm_temp'; // Enter the username for the database
$GLOBALS['pass'] = 'odm_temp'; // Enter the password for the username
$GLOBALS['hostname'] = 'localhost'; // Enter the hostname that is serving the database

$GLOBALS['CONFIG']['base_url'] = 'http://localhost:10088/odm_12';
$GLOBALS['CONFIG']['dataDir'] = '/usr/local/zend/odm_temp_repo/';
