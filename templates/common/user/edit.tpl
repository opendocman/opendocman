<form name="update" id="modifyUserForm" action="user.php" method="POST" enctype="multipart/form-data">
    <table border="0" cellspacing="5" cellpadding="5">
        <tr>
            <td><b>{$g_lang_userpage_id}</b></td><td colspan=4>{$user->id}</td>
            <input type=hidden name=id value="{$user->id}">
            </tr>
        <tr>
            <td><b>{$g_lang_userpage_last_name}</b></td>
            <td colspan=4><input name="last_name" type="text" value="{$user->last_name}" class="required" minlength="2" maxlength="255"></td>
        </tr>
        <tr>
            <td><b>{$g_lang_userpage_first_name}</b></td>
            <td colspan=4><input name="first_name" type="text" value="{$user->first_name}" class="required" minlength="2" maxlength="255"></td>
        </tr>
        <tr>
            <td><b>{$g_lang_userpage_username}</b></td>
            <td colspan=4><input name="username" type="text" value="{$user->username}" class="required" minlength="2" maxlength="25"></td>
        </tr>
        <tr>
            <td><b>{$g_lang_userpage_phone_number}</b></td>
            <td colspan=4><input name="phonenumber" type="text" value="{$user->phone}" maxlegnth="20"></td>
        </tr>
        {if $mysql_auth}
            <tr>
        ...
        <tr>
            ...
            <td colspan=1>
                <input name="admin" type="checkbox" value="1" {if $is_admin}checked{/if} {$mode} id="cb_admin" />
            </td>
        </tr>
