...
$lang['area_add_new_department'] = 'Ajouter un nouveau Département';
$lang['area_add_new_file'] = 'Ajouter un Nouveau Fichier';
$lang['area_add_new_udf'] = 'Ajouter un nouveau Champ Défini par l\'Utilisateur';
...
$lang['button_check_in'] = 'Déverrouiller';
$lang['button_clear_status'] = 'Effacer le Statut';
...
$lang['button_resubmit_for_review'] = 'Re-Soumettre à Révision';
$lang['button_save'] = 'Sauvegarder';
$lang['button_undelete'] = 'Annuler Suppression';
$lang['button_update'] = 'Mettre à Jour';
$lang['button_view_department'] = 'Afficher Département';
$lang['button_yes'] = 'Oui';

//Email
$lang['email_added_to_repository'] = 'ajouté au référentiel';
$lang['email_a_new_file_has_been_added'] = 'Un nouveau fichier a été ajouté';
$lang['email_a_new_file_has_been_rejected'] = 'Un nouveau fichier a été refusé';
$lang['email_automated_document_messenger'] = 'Service de Notifications Automatiques pour les Documents';
$lang['email_because_you_did_not_revise'] = 'parceque vous ne l\'avez pas modifié/révisé deupis plus de';
$lang['email_comments_regarding_review'] = 'Commentaires concernant votre révision du document';
...
$lang['email_email_whole_department'] = 'Envoyer un email à l\'ensemble du département';
$lang['email_file_expired'] = 'Un Fichier a Expiré';
$lang['email_file_was_rejected_because'] = 'Votre fichier a été refusé car vous ne l\'avez pas modifié/révisé deupis plus de ';
$lang['email_file_was_rejected_expired'] = 'Votre fichier a expiré. Merci de mettre le fichier à jour le plus rapidement possible. Votre fichier risque de ne pas être consultable tant que vous n\'aurez pas fait cela.';
$lang['email_for_the_following_reasons'] = 'pour les raisons suivantes';
$lang['email_greeting'] = 'Cher Auteur';
$lang['email_i_would_like_to_inform'] = 'Je souhaite vous informer que';
$lang['email_note_to_authors'] = 'Note à(aux) Auteur(s)';
$lang['email_revision_days'] = 'Nombre maximum de jours avant l\'expiration:';
$lang['email_salute'] = 'Cordialement';
$lang['email_someone_has_requested_password'] = 'Quelqu\'un a demandé une ré-initialisation de (votre) mot de passe.  Si vous souhaitez ré-initialiser votre mot de passe, merci de bien vouloir cliquer sur le line ci dessous.  Si vous ne désirez pas ré-initialiser votre mot de passe, vous ni\'avez rien de spécifique à faire, merci de bien vouloir ignorer cet email.';
$lang['email_status_expired'] = 'Statut: Expiré';
$lang['email_subject_review_status'] = 'Statut des Révisions pour le document ';
$lang['email_subject'] = 'Sujet Personnalisé';
$lang['email_thank_you'] = 'Merci';
$lang['email_to'] = 'Champs À: personnalisé';
$lang['email_was_declined_for_publishing_at'] = 'Refusé pour publication à ';
$lang['email_was_rejected_from_repository'] = 'Refusé par le référentiel';
$lang['email_you_can_now_login'] = 'Vous pouvez maintenant vous identifier dans votre compte sur cette page';
$lang['email_your_account_created'] = 'votre compte de gestion documentaire a été créé à ';
...
$lang['label_admin'] = 'Administration';
$lang['label_allowed'] = 'Autorisé';
$lang['label_all_departments'] = 'Définir tous les Départements comme..';
$lang['label_assign_to'] = 'Assigner à';
...
$lang['label_filetype'] = 'Type de Fichier';
$lang['label_filetypes'] = 'Types de Fichiers';
$lang['label_file_name'] = 'Nom de Fichier';
...
$lang['label_note_for_revision_log'] = 'Note pour l\'historique des Révisions';
$lang['label_page'] = 'Page';
$lang['label_phone_number'] = 'Numéro de Téléhone';
$lang['label_plugins'] = 'Plug-Ins';
$lang['label_prev'] = 'Précédent';
$lang['label_radio_button'] = 'Bouton Radio';
$lang['label_read'] = 'Lu';
...
$lang['label_run_expiration'] = 'Lancer l\'Utilitaire d\'Expiration';
$lang['label_search_term'] = 'Rechercher le Mot';
$lang['label_select_a_department'] = 'Selectionner un département';
$lang['label_select_departments'] = 'Selectionner des départements';
$lang['label_select_one'] = 'Choisir une option';
$lang['label_settings'] = 'Paramètres';
$lang['label_size'] = 'Taille';
$lang['label_specific_permissions'] = 'Permissions Spécifiques à l\'Utilisateur:';
...
$lang['message_documents_rejected'] = 'Documents refusés';
$lang['message_document_successfully_deleted'] = 'Document supprimé avec succès';
$lang['message_documents_waiting'] = 'Documents en attente de relecture';
$lang['message_error_performing_action'] = 'Il y a eu une erreur lors de l\'exécution de l\'action de requête';
$lang['message_file_authorized'] = 'Autorisations sur Fichier effectuées avec succès';
$lang['message_file_does_not_exist'] = 'Le Fichier ne semble pas exister, ou pose problème.';
$lang['message_file_expired'] = 'Fichier Expiré';
$lang['message_file_rejected'] = 'Refus sur fichier effectué avec succès';
$lang['message_folder_error_check'] = 'Erreur de Répertoire. Veuillez lire le message affiché dans la barre d\'état pour obtenir plus d\'informations.';
$lang['message_folder_perms_error'] = 'Erreur de Droits sur Répertoire:';
$lang['message_for_further_assistance'] = 'pour obtenir une aide supplémentaire';
$lang['message_found_documents'] = 'document(s) trouvé(s)';
$lang['message_if_you_are_unable_to_view1'] = 'Si pour quelque raison vous n\'y parvenez pas, cliquez ';
$lang['message_if_you_are_unable_to_view2'] = 'Télécharger';
$lang['message_if_you_are_unable_to_view3'] = '<br> pour commencer le téléchargement sur votre disque local, pour lecture hors ligne.';
...
$lang['message_max_number_of_results'] = 'Il y a trop de réponses merci d\'utiliser la page <a href="search">Rechercher</a> pour affiner vos résultats.';
...
$lang['message_please_upload_valid_doc'] = 'Merci d\'importer un document valide';
$lang['message_record_exists'] = 'L\'enregistrement existe déjà. Essayez à nouveau avec une nouvelle valeur.';
$lang['message_rejected'] = 'Refusé';
$lang['message_rejecting_files'] = 'Refuser les fichiers dont la dernière modification est antérieure à';
$lang['message_reviewers_comments_re_rejection'] = 'Commentaires des Relecteurs relatifs au refus';
$lang['message_session_error'] = 'Erreur de perte de Session. Merci de bien vouloir vous identifier à nouveau.';
$lang['message_set_your_new_password'] = 'Saisissez le nouveau mot de passe dans le formulaire ci-dessous.';
$lang['message_sorry_demo_mode'] = 'Désolé, vous êtes en mode démonstration, vous ne pouvez pas faire cela!';
$lang['message_sorry_not_allowed'] = 'Désolé, vous n\'êtes pas autorisé à faire cela!';
$lang['message_that_filetype_not_supported'] = 'Ce type de fichier n\'est pas actuellement reconnu.<p>Merci d\'importer un document à l\'un des formats suivants, ou ajouter le format manquant (MIMETYPE) à ';
$lang['message_the_code_you_are_using'] = 'Le code que vous venez d\'utiliser pour ré-initialiser votre mot de pase n\'est plus valide. Veuillez utiliser le formulaire suivant afin de recommencer la procédure de ré-initialisation de votre mot de passe.';
$lang['message_the_file_is_too_large'] = 'Ce fichier est trop volumineux. Vérifiez la configuration d\'Opendocman. La taille Maximum autorisée est';
...
$lang['message_udf_successfully_deleted'] = 'Champ Défini par l\'Utilisateur CDU() supprimé avec succès.';
$lang['message_unable_to_determine_root'] = 'Impossible de déterminer le nom d\'utilisateur root. Merci de vérifier votre configuration.';
$lang['message_unable_to_find_file'] = 'Impossible de trouver le fichier demandé';
$lang['message_user_exists'] = 'Ce nom d\'utilisateur existe déjà. Merci <a href=\'signup\'>de bien vouloir réessayer</a>';
...
$lang['message_you_do_not_have_an_account'] = 'Vous n\'avez pas encore de compte. Merci de contacter l\'administrateur pour demander une ouverture de compte.';
$lang['message_you_must_assign_rights'] = 'Vous devez permettre à au moins Un utilisateur d\'avoir des droits en lecture/écriture.';
$lang['message_your_password_has_been_changed'] = 'Votre mot de passe a bien été modifié.';
...
$lang['editpage_check_all'] = 'Tout Sélectionner';
...
// Departments Page
$lang['departmentpage_department_name_required'] = 'Un nom de département est requis';

// Details Page
$lang['detailspage_view'] = 'Afficher';
$lang['detailspage_check_out'] = 'Verrouiller';
$lang['detailspage_edit'] = 'Modifier';
...
$lang['historypage_original_revision'] = 'Révision originelle';
$lang['historypage_latest'] = 'Plus récent';
...
// Profile Page
$lang['profilepage_update_profile'] = 'Mettre à jour le profil utilisateur';

// User Page
$lang['userpage_admin'] = 'Administration';
$lang['userpage_are_sure'] = 'Êtes vous certain de vouloir supprimer ';
$lang['userpage_back'] = 'Retour';
$lang['userpage_button_add_user'] = 'Ajouter Utilisateur';
$lang['userpage_button_cancel'] = 'Annuler';
$lang['userpage_button_delete'] = 'Supprimer';
...
$lang['userpage_id'] = 'ID';
$lang['userpage_last_name'] = 'Nom de Famille';
$lang['userpage_leave_empty'] = 'Laisser vide si non modifié';
$lang['userpage_modify_user'] = 'Modifies Utilisateur';
$lang['userpage_no'] = 'Non';
$lang['userpage_password'] = 'Mot de Passe';
$lang['userpage_phone_number'] = 'Numéro de Téléphone';
$lang['userpage_reviewer'] = 'Relecteur';
$lang['userpage_reviewer_for'] = 'Relecteur pour';
$lang['userpage_show_user'] = 'Afficher Utilisateur: ';
$lang['userpage_status_delete'] = 'Supprimer ';
$lang['userpage_update_user'] = 'Mettre à Jour Utilisateur: ';
$lang['userpage_update_user_demo'] = 'Désolé, mode démonstration seulement, vous ne pouvez pas faire cela';
...
$lang['email_queue_monitor'] = 'Moniteur de File d\'Attente Email';
$lang['email_queue_status'] = 'État de la File d\'Attente Email';
$lang['email_queue_pending'] = 'En attente';
$lang['email_queue_sent'] = 'Envoyé';
$lang['email_queue_failed'] = 'Échec';
$lang['email_queue_retry'] = 'Réessayer';
$lang['email_queue_total'] = 'Total';
$lang['email_queue_process'] = 'Traiter la File';
$lang['email_queue_retry_failed'] = 'Réessayer les Emails Échoués';
$lang['email_queue_delete_old'] = 'Supprimer Anciens';
$lang['email_queue_batch_size'] = 'Taille du lot';
$lang['email_queue_delete_sent_older_than'] = 'Supprimer les emails envoyés antérieurs à';
$lang['email_queue_days'] = 'jours';
$lang['email_queue_no_emails'] = 'Aucun email trouvé dans la file d\'attente';
$lang['email_queue_confirm_retry'] = 'Réinitialiser tous les emails échoués pour un nouvel essai ?';
$lang['email_queue_confirm_delete'] = 'Supprimer les anciens emails envoyés ?';
$lang['email_queue_confirm_delete_single'] = 'Supprimer cet email ?';
$lang['email_queue_cron_setup'] = 'Configuration Tâche Cron';
$lang['email_queue_manual_processing'] = 'Traitement manuel';
$lang['email_queue_auto_refresh'] = 'La page se rafraîchit automatiquement toutes les 30 secondes';
$lang['email_queue_back_to_admin'] = 'Retour à OpenDocMan';
$lang['email_queue_details'] = 'Détails';
$lang['email_queue_delete'] = 'Supprimer';
$lang['email_queue_filter_by_status'] = 'Filtrer par statut';
$lang['email_queue_all_statuses'] = 'Tous les statuts';
$lang['email_queue_limit'] = 'Limite';
$lang['email_queue_refresh_now'] = 'Actualiser maintenant';
$lang['email_queue_last_updated'] = 'Dernière mise à jour';

// Email Queue Interface - Additional Strings
$lang['email_queue_monitor_title'] = 'Moniteur de File d\'Attente Email - OpenDocMan';
$lang['email_queue_monitor_description'] = 'Surveiller et gérer la file d\'attente des notifications email d\'OpenDocMan. La page se rafraîchit automatiquement toutes les 30 secondes.';
$lang['email_queue_back_to_opendocman'] = 'Retour à OpenDocMan';
$lang['email_queue_queue_actions'] = 'Actions de File';
$lang['email_queue_batch_size_label'] = 'Taille du lot :';
$lang['email_queue_delete_sent_older_than_label'] = 'Supprimer les emails envoyés antérieurs à :';
$lang['email_queue_email_list'] = 'Liste des Emails';
$lang['email_queue_id'] = 'ID';
$lang['email_queue_to'] = 'À';
$lang['email_queue_subject'] = 'Sujet';
$lang['email_queue_status_column'] = 'Statut';
$lang['email_queue_retries'] = 'Tentatives';
$lang['email_queue_created'] = 'Créé';
$lang['email_queue_sent_time'] = 'Envoyé';
$lang['email_queue_file_id'] = 'ID Fichier';
$lang['email_queue_actions'] = 'Actions';
$lang['email_queue_error'] = 'Erreur';
$lang['email_queue_cron_setup_title'] = 'Configuration Tâche Cron';
$lang['email_queue_cron_description'] = 'Pour traiter automatiquement la file d\'attente email, ajoutez cette ligne à votre crontab :';
$lang['email_queue_cron_every_minute'] = '# Traiter la file d\'attente email chaque minute';
$lang['email_queue_cron_every_5_minutes'] = '# Ou toutes les 5 minutes pour réduire la charge serveur';
$lang['email_queue_manual_processing_title'] = 'Traitement manuel :';
$lang['email_queue_processed_emails'] = '{count} emails traités. Envoyés : {sent}, Échoués : {failed}';
$lang['email_queue_reset_failed_emails'] = '{count} emails échoués réinitialisés pour nouvel essai';
$lang['email_queue_deleted_old_emails'] = '{count} anciens emails envoyés supprimés (antérieurs à {days} jours)';
$lang['email_queue_email_deleted'] = 'Email supprimé';
