...
//Login
$lang['anonymous_link'] = 'Click para ver Documentos Públicos';
$lang['forgotpassword'] = 'Olvidó su Contrase&nacute;a?';
$lang['signup'] = 'Registrarse como usuario';
$lang['welcome'] = 'Bienvenido a OpenDocMan';
$lang['welcome2'] = 'Debe autenticarse para comenzar a utilizar esta herramienta de almacenamiento, publicación y control de versiones';
...
//Areas
$lang['area_add_new_category'] = 'Agregar Nueva Categoría';
...
$lang['area_check_in_file'] = 'Ingresar Nueva Versión de Documento';
...
$lang['area_department_information'] = 'Información del Area/Departamento';
...
$lang['area_personal_profile'] = 'Información Personal';
$lang['area_reset_password'] = 'Restablecer Contraseña';
...
$lang['area_view_category'] = 'Ver Categorías';
...
$lang['button_check_in'] = 'Ingresar Nueva Versión de Documento';
$lang['button_clear_status'] = 'Borrar Estado';
$lang['button_click_here'] = 'Click Aquí';
...
$lang['button_resubmit_for_review'] = 'Reenviar para Revisión';
...
$lang['email_comments_regarding_review'] = 'Comentario recordando la revisión de Documentos';
...
$lang['email_file_was_rejected_because'] = 'Su Documento ha sido rechazado y puede ser revisado únicamente por';
$lang['email_file_was_rejected_expired'] = 'Su Documento ha caducado. Por favor actualize el archivo tan pronto le sea posible. Su Documento será inaccesible hasta que usted le actualize.';
...
$lang['email_revision_days'] = 'Mãximo Números de días antes de caducar:';
$lang['email_salute'] = 'Cordialmente';
$lang['email_someone_has_requested_password'] = 'Se solicitó restablecer la contraseña. Si desea restablecer su contraseÃ±a por favor siga el siguiente enlace. Si usted no desea restablecer su contraseÃ±a ignore de este correo electrónico.';
$lang['email_status_expired'] = 'Estado: Caducó';
$lang['email_subject_review_status'] = 'Estado de Revisión del Documento ';
$lang['email_subject'] = 'Asunto';
$lang['email_thank_you'] = 'Gracias';
$lang['email_to'] = 'Para';
$lang['email_was_declined_for_publishing_at'] = 'No fué aceptado para su publicación en';
$lang['email_was_rejected_from_repository'] = 'fué rechazado desde el Repositorio';
$lang['email_you_can_now_login'] = 'Usted puede ingresar con su usuario a esta página';
$lang['email_your_account_created'] = 'Su cuenta para gestionar Documento se creo en';
$lang['email_your_file_has_been_authorized'] = 'Su Documento fué aceptado';
...
$lang['label_case_sensitive'] = 'Distinguir Mayúsculas/Minúsculas';
...
$lang['label_default_for_unset'] = 'Usar Configuración por defecto para toda Area/Departamento';
...
$lang['label_file_category'] = 'Categoría del Documento';
$lang['label_file_listing'] = 'Listado de Documentos';
$lang['label_file_location'] = 'Ubicación del Documento';
...
$lang['label_run_expiration'] = 'Ejecutar la Aplicación de Control de Expiración';
$lang['label_search_term'] = 'Término de Búsqueda';
...
$lang['label_settings'] = 'Configuración';
$lang['label_size'] = 'Tamaño';
$lang['label_specific_permissions'] = 'Permisos Específicos del Usuario';
...
$lang['message_account_created_password'] = 'su contraseña aleatória es ';
...
$lang['message_an_email_has_been_sent'] = 'Un mensaje ha sido enviado a su correo con el vínculo  para reestablecer su contraseña.';
$lang['message_anonymous_view'] = 'Ahora esta viendo como usuario anónimo';
$lang['message_are_you_sure_remove'] = 'Está seguro que desea eliminarlo?';
$lang['message_authorized'] = 'Autorizado';
$lang['message_category_successfully_added'] = 'Categoría correctamente agregada';
$lang['message_category_successfully_deleted'] = 'Categoría correctamente eliminada';
$lang['message_category_successfully_updated'] = 'Categoría actualizada Correctamente';
...
$lang['message_config_value_problem'] = 'Existe un problema con uno de los valores de su configuración. Por favor revise.';
$lang['message_current'] = 'Actual';
$lang['message_datadir_problem'] = 'Existe un problema con su dataDir. Revise, asegúrese que existe y es accesible';
$lang['message_datadir_problem_exists'] = 'Existe un problema en la configuración de su dataDir. Parece que Â¡no existe!".';
$lang['message_datadir_problem_writable'] = 'Existe un problema en la configuración de su dataDir. Parece que no es accesible desde su servidor Web.';
...
$lang['message_error_performing_action'] = 'Ha ocurrido un error en la acción solicitada';
...
$lang['message_file_expired'] = 'Documento Caducó';
...
$lang['message_if_you_are_unable_to_view1'] = 'Si usted no puede realizarlo por alguna razÃ³n, click ';
$lang['message_if_you_are_unable_to_view2'] = 'Descargar';
$lang['message_if_you_are_unable_to_view3'] = '<br> Iniciar la descarga del documento en su computadora para un manejo cómodo.';
$lang['message_initial_import'] = 'Importación Inicial';
$lang['message_last_message'] = 'Último Mensaje:';
$lang['message_latest_version'] = 'Esta es la Versión mas Reciente';
...
$lang['message_no_author_comments_available'] = 'El autor no generó comentarios';
$lang['message_no_description_available'] = 'Descripción no disponible';
...
$lang['message_original_version'] = 'Versión Original';
$lang['message_please_email'] = 'Por favor su correo electrónico';
$lang['message_please_upload_valid_doc'] = 'Por favor suba un Documento válido';
$lang['message_record_exists'] = 'Identificación ya existente. Trate un valor diferente.';
$lang['message_rejected'] = 'Rechazado';
$lang['message_rejecting_files'] = 'Ultimos Documentos rechazados sin revisión';
...
$lang['message_set_your_new_password'] = 'Configure su contraseña en el siguiente formulario.';
...
$lang['message_the_code_you_are_using'] = 'La contraseña ingresada no tiene una longitud válida.  Use el siguiente formulario para reestablecer su contraseña.';
$lang['message_the_file_is_too_large'] = 'El archivo es demasiado grande. Revise en la configuración el máximo permitido';
$lang['message_the_file_is_too_large_php_ini'] = 'Archivo es demasiado grande reporta su servidor php. Revise la configuración de su php.ini ajustando los límites upload/post/memory. Actualmente el tamaÃ±o máximo es: ';
$lang['message_the_username_you_entered'] = 'El usuario no se encuentra en el sistema.  Contactenos si olvidó su Nombre de Usuario.';
$lang['message_there_was_an_error_loggin_you_in'] = 'Ha ocurrido un error ingresando. Por favor trate nuevamente.';
$lang['message_there_was_an_error_performing_the_action'] = 'Ha ocurrido un error en la acción solicitada.';
$lang['message_this_file_cannot_be_checked_in'] = 'No se puede Desbloquear/Actualizar la versión con este archivo';
$lang['message_this_file_cannot_be_uploaded'] = 'El archivo no pudo ser enviado apropiadamente';
$lang['message_this_operation_cannot_be_done_file'] = 'La operación no puede  ser realizada en este archivo';
$lang['message_this_operation_cannot_be_done_rev'] = 'Esta operación no esta permitida para revisar un archivo';
$lang['message_this_page_requires_root'] = 'Esta página requiere niveles administrativos';
$lang['message_this_site_has_high_security'] = 'Este sitio tiene niveles de seguridad que nos impiden recuperar su contraseña, usted puede usar el formulario para reeestablecerla .  Ingrese su nombre de usuario y se le enviará a su correo un mensaje con un vínculo que le permitirá restablecerla. Luego de ello podrÃ¡ cambiarla a la que usted desee.';
...
$lang['message_unable_to_determine_root'] = 'Imposible determinar el nombre de usuario admisnitrador. Revise su configuración.';
$lang['message_unable_to_find_file'] = 'No se puede encontrar el archivo requerido';
$lang['message_user_exists'] = 'El usuario ya existe. Por favor trate nuevamente <a href=\'signup\'></a>';
...
$lang['message_you_must_assign_rights'] = 'Usted debería asignar al menos a un ususario la propiedad de  Ver/Modificar.';
...
// History Page
$lang['historypage_category'] = 'Categoría:';
$lang['historypage_file_size'] = 'Tamano del Archivo:';
$lang['historypage_creation_date'] = 'Fecha de Creación:';
$lang['historypage_owner'] = 'Propietario:';
$lang['historypage_description'] = 'Descripción:';
$lang['historypage_comment'] = 'Comentario:';
$lang['historypage_revision'] = 'Revisión:';
$lang['historypage_original_revision'] = 'Revisión Original';
$lang['historypage_latest'] = 'Ultima';
$lang['historypage_history'] = 'Historial';
$lang['historypage_version'] = 'Versión';
...
$lang['userpage_confirm_password'] = 'Confirmar contraseña';
...
$lang['userpage_no'] = 'No';
$lang['userpage_password'] = 'Contraseña';
$lang['userpage_phone_number'] = 'Número Telefónico';
...
$lang['userpage_user_info'] = 'Información del Usuario';
$lang['userpage_username'] = 'Usuario';
$lang['userpage_yes'] = 'Sí';
...
$lang['adminpage_edit_settings'] = 'Editar Configuración';
...
//Category View Page
$lang['categoryviewpage_list_of_files_title'] = 'Archivos Asignados a esta Categoría:';
...
$lang['email_queue_monitor'] = 'Monitor de Cola de Correo';
$lang['email_queue_status'] = 'Estado de Cola de Correo';
$lang['email_queue_pending'] = 'Pendiente';
$lang['email_queue_sent'] = 'Enviado';
$lang['email_queue_failed'] = 'Fallido';
$lang['email_queue_retry'] = 'Reintentar';
$lang['email_queue_total'] = 'Total';
$lang['email_queue_process'] = 'Procesar Cola';
$lang['email_queue_retry_failed'] = 'Reintentar Correos Fallidos';
$lang['email_queue_delete_old'] = 'Eliminar Antiguos';
$lang['email_queue_batch_size'] = 'Tamaño de lote';
$lang['email_queue_delete_sent_older_than'] = 'Eliminar correos enviados anteriores a';
$lang['email_queue_days'] = 'días';
$lang['email_queue_no_emails'] = 'No se encontraron correos en la cola';
$lang['email_queue_confirm_retry'] = '¿Restablecer todos los correos fallidos para reintento?';
$lang['email_queue_confirm_delete'] = '¿Eliminar correos enviados antiguos?';
$lang['email_queue_confirm_delete_single'] = '¿Eliminar este correo?';
$lang['email_queue_cron_setup'] = 'Configuración de Tarea Cron';
$lang['email_queue_manual_processing'] = 'Procesamiento manual';
$lang['email_queue_auto_refresh'] = 'La página se actualiza automáticamente cada 30 segundos';
$lang['email_queue_back_to_admin'] = 'Volver a OpenDocMan';
$lang['email_queue_details'] = 'Detalles';
$lang['email_queue_delete'] = 'Eliminar';
$lang['email_queue_filter_by_status'] = 'Filtrar por estado';
$lang['email_queue_all_statuses'] = 'Todos los estados';
$lang['email_queue_limit'] = 'Límite';
$lang['email_queue_refresh_now'] = 'Actualizar ahora';
$lang['email_queue_last_updated'] = 'Última actualización';

// Email Queue Interface - Additional Strings
$lang['email_queue_monitor_title'] = 'Monitor de Cola de Correo - OpenDocMan';
$lang['email_queue_monitor_description'] = 'Monitorear y gestionar la cola de notificaciones de correo de OpenDocMan. La página se actualiza automáticamente cada 30 segundos.';
$lang['email_queue_back_to_opendocman'] = 'Volver a OpenDocMan';
$lang['email_queue_queue_actions'] = 'Acciones de Cola';
$lang['email_queue_batch_size_label'] = 'Tamaño de lote:';
$lang['email_queue_delete_sent_older_than_label'] = 'Eliminar correos enviados anteriores a:';
$lang['email_queue_email_list'] = 'Lista de Correos';
$lang['email_queue_id'] = 'ID';
$lang['email_queue_to'] = 'Para';
$lang['email_queue_subject'] = 'Asunto';
$lang['email_queue_status_column'] = 'Estado';
$lang['email_queue_retries'] = 'Reintentos';
$lang['email_queue_created'] = 'Creado';
$lang['email_queue_sent_time'] = 'Enviado';
$lang['email_queue_file_id'] = 'ID de Archivo';
$lang['email_queue_actions'] = 'Acciones';
$lang['email_queue_error'] = 'Error';
$lang['email_queue_cron_setup_title'] = 'Configuración de Tarea Cron';
$lang['email_queue_cron_description'] = 'Para procesar automáticamente la cola de correo, agregue esta línea a su crontab:';
$lang['email_queue_cron_every_minute'] = '# Procesar cola de correo cada minuto';
$lang['email_queue_cron_every_5_minutes'] = '# O cada 5 minutos para menor carga del servidor';
$lang['email_queue_manual_processing_title'] = 'Procesamiento manual:';
$lang['email_queue_processed_emails'] = 'Procesados {count} correos. Enviados: {sent}, Fallidos: {failed}';
$lang['email_queue_reset_failed_emails'] = 'Restablecidos {count} correos fallidos para reintento';
$lang['email_queue_deleted_old_emails'] = 'Eliminados {count} correos enviados antiguos (anteriores a {days} días)';
$lang['email_queue_email_deleted'] = 'Correo eliminado';
