...
$lang['area_update_department'] = 'Atualizar Departamento';
$lang['area_update_file'] = 'Atualizar Arquivo';
$lang['area_view_category'] = 'Ver categoria';
$lang['area_view_history'] = 'Histórico';
...
$lang['email_automated_document_messenger'] = 'Mensageiro de Documento Automatizado';
$lang['email_because_you_did_not_revise'] = 'porque você não revisou por mais de';
$lang['email_comments_regarding_review'] = 'Comentários a respeito de sua revisão do documento';
$lang['email_custom_comment'] = 'Comentário Personalizado';
$lang['email_email_all_users'] = 'Enviar para todos os usuários';
$lang['email_email_these_users'] = 'Enviar para estes usuários';
$lang['email_email_whole_department'] = 'Enviar para todos os usuarios do departamento';
$lang['email_file_expired'] = 'O arquivo expirou';
$lang['email_file_was_rejected_because'] = 'Seu arquivo foi rejeitado porque você não fêz revisão por mais de';
$lang['email_file_was_rejected_expired'] = 'O seu arquivo expirou. Por favor, atualizar o arquivo o mais rápido possível. O arquivo pode ficar inacessível até que você.';
...
$lang['label_email_address'] = 'Endereço de email';
$lang['label_empty'] = 'Vazio';
$lang['label_exact_phrase'] = 'Frase Exata';
$lang['label_example'] = 'Exemplo';
$lang['label_file_archive'] = 'Arquivamento de Arquivo';
...
$lang['label_radio_button'] = 'Botão Radio';
$lang['label_read'] = 'Ler';
$lang['label_reassign_to'] = 'Re-atribuir a';
$lang['label_rejected_files'] = 'Arquivos rejeitados';
$lang['label_rejections'] = 'Rejeição';
$lang['label_reviewer_for'] = 'Departamento revisor para';
$lang['label_reviewer'] = 'Revisor';
$lang['label_reviews'] = 'Revisores';
$lang['label_rights'] = 'Permissões';
$lang['label_run_expiration'] = 'Execute o Utilitário de Validade';
$lang['label_search_term'] = 'Termo de Pesquisa';
$lang['label_select_a_department'] = 'Selecionar um departamento';
$lang['label_select_departments'] = 'Selecionar departamentos';
$lang['label_select_one'] = 'Selecionar um';
$lang['label_settings'] = 'Configurações';
$lang['label_size'] = 'Tamanho';
$lang['label_specific_permissions'] = 'Permissões Espacíficas de Usuário';
$lang['label_status'] = 'Status';
$lang['label_text'] = 'Texto';
$lang['label_update'] = 'Atualizar';
$lang['label_user_defined_fields'] = 'Campos Definidos pelo Usuário';
$lang['label_user_defined_field'] = 'Campo Definido pelo Usuário';
$lang['label_users_in_department'] = 'Usuários neste dapartamento';
$lang['label_user'] = 'Usuário';
$lang['label_view'] = 'Visualizar';
$lang['label_userid'] = 'ID do Usuário';
$lang['label_fileid'] = 'Arquivo de ID';
...
$lang['message_anonymous_view'] = 'Você foi direcionado para o modo de exibição anônimo';
$lang['message_are_you_sure_remove'] = 'Você tem certeza que deseja remover isto?';
$lang['message_authorized'] = 'Autorizado';
$lang['message_category_successfully_added'] = 'Categoria adicionada com sucesso';
$lang['message_category_successfully_deleted'] = 'Categoria excluída com sucesso';
$lang['message_category_successfully_updated'] = 'Categoria atualizada com sucesso';
$lang['message_click_to_checkout_document'] = 'Clique para verificar o documento selecionado e começar a fazer o download para sua estação de trabalho local';
$lang['message_config_value_problem'] = 'Há um problema com um de seus valores de configuração. Por favor, verifique.';
$lang['message_confirm_delete_item'] = 'Are you sure you want to delete this item?';
$lang['message_current'] = 'Corrente';
$lang['message_datadir_problem'] = 'Há um problema com o seu dataDir. Certifique-se de que ele existe e é gravável';
$lang['message_datadir_problem_exists'] = 'Há um problema com a configuração do dataDir. Ele não parece existir.';
$lang['message_datadir_problem_writable'] = 'Há um problema com a configuração dataDir. Não parece ser gravável para o servidor web.';
$lang['message_department_successfully_added'] = 'Departamento adicionado com sucesso';
$lang['message_department_successfully_updated'] = 'Departamento atualizado com sucesso';
...
$lang['message_documents_rejected'] = 'Documentos rejeitados';
$lang['message_document_successfully_deleted'] = 'Document0 eliminado com sucesso';
$lang['message_documents_waiting'] = 'Documentos esperando para serem revizados';
$lang['message_error_performing_action'] = 'Houve um erro ao executar a ação pedida';
$lang['message_file_authorized'] = 'Autorização de arquivo concluída com êxito';
$lang['message_file_does_not_exist'] = 'O arquivo não existe ou há um problema com o arquivo.';
$lang['message_file_expired'] = 'Arquivo Expirado';
$lang['message_file_rejected'] = 'Rejeição de arquivo concluída com sucesso';
$lang['message_folder_error_check'] = 'Erro na pasta. Verifique última mensagem na barra de status para obter detalhes.';
$lang['message_folder_perms_error'] = 'Erro nas Permissões de Pasta:';
$lang['message_for_further_assistance'] = 'para maiores esclarecimentos';
$lang['message_found_documents'] = 'documento(s) encontrado(s)';
$lang['message_if_you_are_unable_to_view1'] = 'Se você não é capaz de fazê-lo por algum motivo, clique  ';
$lang['message_if_you_are_unable_to_view2'] = 'Baixar';
$lang['message_if_you_are_unable_to_view3'] = '<br> para começar a fazer o download para sua estação de trabalho local para exibição local.';
...
$lang['message_no_documents_checked_out'] = 'Nenhum documento atualmente foi check-out para você.';
$lang['message_no_files_found'] = 'Nenhum Arquivo Encontrado';
$lang['message_no_information_available'] = 'Nenhuma informação disponível';
...
$lang['message_please_upload_valid_doc'] = 'Faça envio de um documento válido';
$lang['message_record_exists'] = 'Registro já existe. Tente novamente com um valor diferente.';
$lang['message_rejected'] = 'Rejeitado';
$lang['message_rejecting_files'] = 'Rejeitando últimos arquivos editados antes';
$lang['message_reviewers_comments_re_rejection'] = 'Comentários de revisores sobre rejeições';
$lang['message_session_error'] = 'Erro na seção. Por favor entre novamente.';
$lang['message_set_your_new_password'] = 'Defina a sua nova senha utilizando o formulário abaixo.';
$lang['message_sorry_demo_mode'] = 'Desculpe, modo de demonstração, você não pode fazer isso!';
$lang['message_sorry_not_allowed'] = 'Desculpe, você não tem permissão para fazer isso!';
$lang['message_that_filetype_not_supported'] = 'Esse tipo de arquivo não é suportado. <p> Carregar um documento em conformidade com qualquer um dos seguintes tipos de arquivos ou adicionar o que faltava para MIMETYPE ';
$lang['message_the_code_you_are_using'] = 'O código que você está tentando usar para redefinir sua senha não é mais válida. Utilize o formulário abaixo para redefinir sua senha.';
$lang['message_the_file_is_too_large'] = 'O arquivo é muito grande. Verifique as configurações de OpenDocMan. O tamanho máximo é';
$lang['message_the_file_is_too_large_php_ini'] = 'O arquivo é muito grande para o servidor php. Verifique a configuração do php.ini para um máximo de upload/post/memory. O tamanho máximo é atualmente: ';
$lang['message_there_was_an_error_loggin_you_in'] = 'Houve um erro em sua conexão. Por favor, tente novamente.';
$lang['message_there_was_an_error_performing_the_action'] = 'Houve um erro ao executar a ação solicitada.';
$lang['message_the_username_you_entered'] = 'O nome de usuário que você digitou não foi encontrado em nosso sistema. Contacte-nos se você esqueceu seu nome de usuário.';
$lang['message_this_file_cannot_be_checked_in'] = 'Este arquivo não pode ser verificado';
$lang['message_this_file_cannot_be_uploaded'] = 'Este arquivo não pode ser enviado corretamente';
$lang['message_this_operation_cannot_be_done_file'] = 'Esta operação não pode ser feita com este arquivo';
$lang['message_this_operation_cannot_be_done_rev'] = 'Esta operação não pode ser feita para a revisão de um arquivo';
$lang['message_this_page_requires_root'] = 'Esta página requer permissão de nível de root';
$lang['message_this_site_has_high_security'] = 'Este site tem um alto nível de segurança, e não podemos recuperar a sua senha para você. Você pode utilizar este formulário para redefinir sua senha. Digite seu nome de usuário e nós enviaremos um e-mail para o endereço de e-mail em arquivo com um link que você deve seguir para redefinir sua senha. A partir daí, você pode configurá-la para qualquer coisa que você quiser.';
...
$lang['message_user_exists'] = 'Esse usuário já existe. Por favor<a href=\'signup\'>tente novamente</a>';
...
// Add File Page
$lang['addpage_forbidden'] = 'Proibido';
$lang['addpage_none'] = 'Não definido';
$lang['addpage_view'] = 'Visualizar';
$lang['addpage_read'] = 'Ler';
$lang['addpage_write'] = 'Escrever';
...
$lang['editpage_none_selected'] = 'Selecione as opções';
$lang['editpage_assign_owner'] = 'Atribuir proprietário';
$lang['editpage_assign_department'] = 'Atribuir ao departamento';
$lang['editpage_filter'] = 'Filtrar:';
$lang['editpage_keyword'] = 'Entrar palavras chave';
$lang['editpage_forbidden'] = 'Proibido';
$lang['editpage_none'] = 'Não definido';
$lang['editpage_view'] = 'Visualizar';
$lang['editpage_read'] = 'Ler';
$lang['editpage_write'] = 'Escrever';
...
$lang['filepermissionspage_perm_overview'] = 'Visão geral';
$lang['filepermissionspage_perm_add'] = 'Adicionar';
$lang['filepermissionspage_perm_inherited_from'] = 'Heredado de %s';
$lang['filepermissionspage_perm_inherited'] = 'heredado';
$lang['filepermissionspage_perm_no_permissions'] = 'Não foram definidas autorizações';

// Delete/Undeleta Admin Page
$lang['undeletepage_file_permanently_deleted'] = 'O arquivo foi excluído permanentemente';
$lang['undeletepage_file_undeleted'] = 'O arquivo foi recuperado';

// Departments Page
$lang['departmentpage_department_name_required'] = 'O nome do departamento é necessário';

// Details Page
$lang['detailspage_view'] = 'Visualizar';
$lang['detailspage_check_out'] = 'Check out';
$lang['detailspage_edit'] = 'Editar';
$lang['detailspage_delete'] = 'Eliminar';
$lang['detailspage_history'] = 'Histórico';
$lang['detailspage_are_sure'] = 'Você tem certeza?';
$lang['detailspage_file_checked_out_to'] = 'Checked out para';

// Out Page
$lang['outpage_view'] = 'Visualizar';
$lang['outpage_ascending'] = 'Ascendente';
$lang['outpage_descending'] = 'Descendente';
$lang['outpage_choose_an_order'] = 'Escolher uma ordem';
$lang['outpage_choose'] = 'Escolher';
$lang['category_option_author'] = 'Autor';
$lang['category_option_department'] = 'Departamento';
$lang['category_option_category'] = 'Categoria do Arquivo';
$lang['category_option_default'] = 'Vazio';

// History Page
$lang['historypage_category'] = 'Categoria:';
$lang['historypage_file_size'] = 'Tamanho do arquivo:';
$lang['historypage_creation_date'] = 'Data de criação:';
$lang['historypage_owner'] = 'Proprietário:';
$lang['historypage_description'] = 'Descrição:';
$lang['historypage_comment'] = 'Comentário:';
$lang['historypage_revision'] = 'Revisão:';
$lang['historypage_original_revision'] = 'Revisão Original';
$lang['historypage_latest'] = 'Última';
$lang['historypage_history'] = 'História';
$lang['historypage_version'] = 'Versão';
$lang['historypage_modification'] = 'Data de modificação';
$lang['historypage_by'] = 'Por';
$lang['historypage_note'] = 'Nota';
$lang['historypage_pending'] = 'Pendente';

// Profile Page
$lang['profilepage_update_profile'] = 'Atualizar perfil pessoal';

// User Page
$lang['userpage_admin'] = 'Admin';
$lang['userpage_are_sure'] = 'Tem certeza de que deseja excluir ';
$lang['userpage_back'] = 'Retornar';
$lang['userpage_button_add_user'] = 'Adicionar Usuário';
$lang['userpage_button_cancel'] = 'Cancelar';
$lang['userpage_button_delete'] = 'Excluir';
$lang['userpage_button_modify'] = 'Modificar Usuário';
$lang['userpage_button_show'] = 'Mostrar Usuário';
$lang['userpage_button_update'] = 'Atualizar Usuário';
$lang['userpage_can_add'] = 'Can Add Documents';
$lang['userpage_can_checkin'] = 'Can Check-In Documents';
$lang['userpage_choose_departments'] = 'Escolher o departamento(s)';
$lang['userpage_choose_user'] = 'Escolher o Usuário para Visualizar';
$lang['userpage_confirm_password'] = 'Confirmar Senha';
$lang['userpage_department'] = 'Departamento';
$lang['userpage_email'] = 'E-mail';
$lang['userpage_first_name'] = 'Primeiro nome';
$lang['userpage_id'] = 'ID';
$lang['userpage_last_name'] = 'Último nome';
$lang['userpage_leave_empty'] = 'Deixe em branco se inalterada';
$lang['userpage_modify_user'] = 'Modificar Usuário';
$lang['userpage_no'] = 'Não';
$lang['userpage_password'] = 'Senha';
$lang['userpage_phone_number'] = 'Número do telefone';
$lang['userpage_reviewer'] = 'Revisor';
$lang['userpage_reviewer_for'] = 'Revisor para';
$lang['userpage_show_user'] = 'Mostrar Usuário: ';
$lang['userpage_status_delete'] = 'Excluir ';
$lang['userpage_update_user'] = 'Atualizar Usuário: ';
$lang['userpage_update_user_demo'] = 'Desculpe, modo de demonstração, você não pode fazer isso';
$lang['userpage_user'] = 'Usuário';
$lang['userpage_user_delete'] = 'Escolha o Usuário para Eliminar';
$lang['userpage_user_info'] = 'Informações do Usuário';
$lang['userpage_username'] = 'Nome do Usuário';
...
$lang['adminpage_access_log'] = 'Acessar o Log';
$lang['adminpage_reports_file_list'] = 'Exportar Lista de Arquivos';
...
$lang['accesslogpage_file_modified'] = 'Arquivo Modificado';
$lang['accesslogpage_file_checked_in'] = 'Arquivo Checked-in';
$lang['accesslogpage_file_checked_out'] = 'Arquivo Checked-out';
$lang['accesslogpage_file_deleted'] = 'Arquivo Excluído';
$lang['accesslogpage_file_authorized'] = 'Arquivo Autorizado';
$lang['accesslogpage_file_rejected'] = 'Arquivo Rejeitado';
$lang['accesslogpage_reserved'] = 'Reservado';

// Check-in Page
$lang['checkinpage_file_was_checked_in'] = 'Um arquivo foi checked in.';
...
$lang['settings_group_security'] = 'Segurança & Autenticação';
$lang['settings_group_storage'] = 'Tipos de arquivo & Armazenamento';
$lang['settings_group_email'] = 'E-mail & Notificações';
$lang['settings_group_review'] = 'Revisão & Autorização';
$lang['settings_group_appearance'] = 'Interface & Aparência';
$lang['settings_group_other'] = 'Outros';
$lang['settings_sidebar_group_content'] = 'Gerenciamento de conteúdo';
$lang['settings_sidebar_group_files'] = 'Arquivos';
$lang['settings_sidebar_group_system'] = 'Configurações & Sistema';
$lang['settings_sidebar_group_reports'] = 'Relatórios';
$lang['settings_sidebar_group_settings_groups'] = 'Grupos de configurações';
$lang['settings_sidebar_search'] = 'Pesquisar na administração…';
$lang['settings_filter'] = 'Pesquisar nas configurações…';
$lang['admin_quick_actions'] = 'Ações rápidas';
$lang['about_app_version'] = 'Versão do aplicativo';
$lang['about_db_version'] = 'Versão do banco de dados';
$lang['label_files'] = 'Documentos';
