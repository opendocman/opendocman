...
// Main file for creating a fresh installation
...
$query = "INSERT INTO {$dbprefix}odmsys VALUES (NULL,'version','1.4.0')";
$stmt = $pdo->prepare($query);
$stmt->execute();
...
"INSERT INTO `{$dbprefix}settings` VALUES(NULL, 'theme', 'bootstrap5', 'Which theme to use?', '');",
...
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'image/webp', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'image/bmp', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'image/tiff', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'image/tif', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'image/svg+xml', 1);",
...
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'application/vnd.ms-access', 1);",
...
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'text/xml', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'application/json', 1);",
...
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'application/x-rar-compressed', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'application/x-7z-compressed', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'application/x-tar', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'application/gzip', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'application/x-bzip2', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'application/octet-stream', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'audio/mpeg', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'audio/ogg', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'audio/x-wav', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'audio/x-flac', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'video/mp4', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'video/mpeg', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'video/x-msvideo', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'video/x-ms-wmv', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'video/quicktime', 1);",
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'video/webm', 1);",
