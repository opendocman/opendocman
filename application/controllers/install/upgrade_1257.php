...
// Database upgrades for users upgrading from 1.2.5.7 or 1.2.6beta
...
"INSERT INTO `{$_SESSION['db_prefix']}settings` VALUES(NULL,'theme', 'bootstrap5', 'Which theme to use?', '');",
