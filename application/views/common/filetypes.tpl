...
<table class="form-table" style="width: 200px;">
        ...
        <tr>
            <td>
                <a href="filetypes?submit=AddNew">{$g_lang_label_add}&nbsp;{$g_lang_label_filetype}</a>&nbsp;|&nbsp;<a href="filetypes?submit=DeleteSelect">{$g_lang_label_delete}&nbsp;{$g_lang_label_filetype}</a>
            </td>
        </tr>
        <tbody>
    </table>
