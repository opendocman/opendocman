...
INSERT INTO `odm_user` VALUES (NULL,'admin','$2y$12$c31hxIW5PiBCdNdw.3sVkOKENaQZfgq2wbhrU6pkzaimT5zdyfJWm','1','5555551212','admin@example.com','User','Admin','',1,1,1,NULL);
...
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_enabled', 'False', 'Enable the email document ingest feature', 'bool');
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_host', '', 'Mail server host for the ingest mailbox', 'alpha|req');
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_port', '993', 'Mail server port', 'num');
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_protocol', 'imap', 'Mailbox protocol: imap or pop3', 'alpha');
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_encryption', 'ssl', 'Mailbox encryption: none, ssl, or tls', 'alpha');
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_user', '', 'Mailbox username', '');
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_pass', '', 'Mailbox password', '');
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_folder', 'INBOX', 'Mailbox folder to poll', 'alpha');
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_validate_cert', 'True', 'Verify the TLS certificate when connecting to the mail server. Disable only if the mailbox hostname does not match the certificate', 'bool');
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_audit_retention_days', '90', 'How many days to keep email ingest audit log entries (0 = keep forever)', 'num');
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_delete', 'False', 'Delete processed messages from the mailbox after ingestion', 'bool');
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_default_category', '', 'Default category id for ingested documents', '');
INSERT INTO `odm_settings` VALUES(NULL, 'incoming_mail_default_department', '', 'Default department id for ingested documents', '');
...
INSERT INTO `odm_filetypes` VALUES(NULL, 'image/webp', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'image/bmp', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'image/tiff', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'image/tif', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'image/svg+xml', 1);
...
INSERT INTO `odm_filetypes` VALUES(NULL, 'application/vnd.ms-access', 1);
...
INSERT INTO `odm_filetypes` VALUES(NULL, 'text/xml', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'application/json', 1);
...
INSERT INTO `odm_filetypes` VALUES(NULL, 'application/x-rar-compressed', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'application/x-7z-compressed', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'application/x-tar', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'application/gzip', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'application/x-bzip2', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'application/octet-stream', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'audio/mpeg', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'audio/ogg', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'audio/x-wav', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'audio/x-flac', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'video/mp4', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'video/mpeg', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'video/x-msvideo', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'video/x-ms-wmv', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'video/quicktime', 1);
INSERT INTO `odm_filetypes` VALUES(NULL, 'video/webm', 1);
