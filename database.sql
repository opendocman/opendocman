...
INSERT INTO `odm_settings` VALUES(NULL,'root_username', 'admin', 'This variable sets the root username.  The root user will be able to access all files and have authority for everything.', 'alpha|req|maxsize=255');
