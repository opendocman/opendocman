...
// Translator:  Ernesto Parra <eparrarincon@gmail.com>
/*
...
$lang['email_someone_has_requested_password'] = 'Se solicit&oacute; restablecer la contrase&ntilde;a. Si desea restablecer su contraseÃ±a por favor siga el siguiente enlace. Si usted no desea restablecer su contraseÃ±a ignore de este correo electr&oacute;nico.';
...
$lang['message_datadir_problem_exists'] = 'Existe un problema en la configuraci&oacute;n de su dataDir. Parece que Â¡no existe!".';
...
$lang['message_the_file_is_too_large_php_ini'] = 'Archivo es demasiado grande reporta su servidor php. Revise la configuraci&oacute;n de su php.ini ajustando los l&iacute;mites upload/post/memory. Actualmente el tamaÃ±o m&aacute;ximo es: ';
...
$lang['message_this_site_has_high_security'] = 'Este sitio tiene niveles de seguridad que nos impiden recuperar su contrase&ntilde;a, usted puede usar el formulario para reeestablecerla .  Ingrese su nombre de usuario y se le enviar&aacute; a su correo un mensaje con un v&iacute;nculo que le permitir&aacute; restablecerla. Luego de ello podrÃ¡ cambiarla a la que usted desee.';
