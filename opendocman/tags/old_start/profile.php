...
<tr><td><center><a href="user.php?submit=Modify+User&item=<?php echo $SESSION_UID; ?>&callee=<?php echo $_SERVER['PHP_SELF']; ?>update_pwd=true">Change Personal Info</a><center></td></tr>
</table>
</center>
<?php
draw_footer();
