...
"INSERT INTO `{$dbprefix}settings` VALUES(NULL, 'theme', 'default', 'Which theme to use?', '');",
...
"INSERT INTO `{$dbprefix}filetypes` VALUES(NULL, 'applicatiion/vnd.openxmlformats-officedocument.presenationml.presentation', 1);",
