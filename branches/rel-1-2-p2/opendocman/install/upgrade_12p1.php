...
$result = mysql_query("
ALTER TABLE admin MODIFY id int(11) unsigned NOT NULL COMMENT ''
...
$result = mysql_query("
ALTER TABLE category MODIFY id int(11) unsigned NOT NULL COMMENT '' auto_increment;
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE data MODIFY id int(11) unsigned NOT NULL COMMENT '' auto_increment;
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE data MODIFY category int(11) unsigned NOT NULL COMMENT '';
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE data MODIFY owner int(11) unsigned NULL DEFAULT NULL COMMENT '';
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE data MODIFY reviewer int(11) unsigned NULL DEFAULT NULL COMMENT '';
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE department MODIFY id int(11) unsigned NOT NULL COMMENT '' auto_increment;
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE dept_perms MODIFY fid int(11) unsigned NULL DEFAULT NULL COMMENT '';
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE dept_perms MODIFY dept_id int(11) unsigned NULL DEFAULT NULL COMMENT '';
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE dept_reviewer MODIFY dept_id int(11) unsigned NULL DEFAULT NULL COMMENT '';
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE dept_reviewer MODIFY user_id int(11) unsigned NULL DEFAULT NULL COMMENT '';
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE log MODIFY id int(11) unsigned NOT NULL COMMENT '';
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE user MODIFY department int(11) unsigned NULL DEFAULT NULL COMMENT '';
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE user_perms MODIFY fid int(11) unsigned NULL DEFAULT NULL COMMENT '';
") or die("<br>Could not update" . mysql_error());
...
$result = mysql_query("
ALTER TABLE user_perms MODIFY uid int(11) unsigned NOT NULL COMMENT '';
") or die("<br>Could not update" . mysql_error());
